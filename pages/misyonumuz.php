...
<?php 
    if (isset($_POST['save'])) {
        if ($_POST['save'] == 1001) {
            ...
            $sql = "INSERT INTO qp_mission (tittle, description, adddate, user_id, statu) VALUES (?,?,?,?,?)";
    ...
    if (isset($_POST['update'])) {
        if ($_POST['update'] == 1002) {
            ...
            $statu = $_POST['statu'][0];
            $sql="UPDATE qp_mission SET tittle=?, description=?, statu=? WHERE id = ?";
...
?>
    ...
    <section class="content">
      <div class="container-fluid">
                  ...
                  <tr>
                    ...
                    <div class="modal fade" id="modal-default<?php print $value['id'];?>">
                            ...
                            <div class="modal-content">
                                ...
                                <h4 class="modal-title">Misyonumuz | Sil</h4>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Misyonumuz | Güncelle</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
  ...
  <div class="modal fade" id="modal-default-newpost">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Misyonumuz | Yeni Ekle</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
