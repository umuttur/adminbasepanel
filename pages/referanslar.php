              ...
              <div class="card-header">
                ...
                if (isset($_POST['save'])) {
                    if ($_POST['save']==1001) {
                        ...
                        $sql="INSERT INTO qp_referanslar(tittle, description, image, adddate, user_id, statu) VALUES (?,?,?,?,?,?)";
                        $args= [$tittle, $description, $image, $adddate, $user_id, $statu];
              ...
              <div class="card-body">
                ...
                if (isset($_POST['deleteData'])) {
                  if ($_POST['deleteData']== 1001) {
                    ...
                    $sql1001 = "SELECT * FROM qp_referanslar WHERE id IN ('$deleteData')";
                    $stmt = $adminclass->pdoQuery($sql1001);
                    $sql = "DELETE FROM qp_referanslar WHERE id IN ('$deleteData')";
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                  <?php 
                  $sql = "SELECT * FROM qp_referanslar";
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="referanslar_edit?id=<?php print $value['id']; ?>" class="btn btn-primary">Güncelle</a>
                    </td>
                  </tr>
                  <?php } }?>
                  </tbody>
