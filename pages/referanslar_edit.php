          ...
          <?php 
                    ...
                    if ($_POST['save']==1001) {
                        ...
                        if ($image_tmp != '') {
                            if (file_exists($image)) {
                                ...
                                $sql = "SELECT image FROM qp_referanslar WHERE id = {$id}";
                                ...
                                $sql="UPDATE qp_referanslar SET tittle=?, description=?, adddate=?, user_id=?, statu=?, image=? WHERE id=?";
                                $args= [$tittle, $description, $adddate, $user_id, $statu, $image, $id];
                        ...
                        $sql="UPDATE qp_referanslar SET tittle=?, description=?, adddate=?, user_id=?, statu=? WHERE id=?";
                        $args= [$tittle, $description, $adddate, $user_id, $statu, $id];
                        $args = $adminclass->getSecurity($args);
                        $query = $adminclass->pdoPrepare($sql,$args);
                        if ($query) {
            ...
            <div class="card card-success">
              ...
              <form method="POST" enctype="multipart/form-data">
                ...
                <?php 
                $sql = "SELECT * FROM qp_referanslar WHERE id = {$id}";
                $query = $adminclass->pdoQuery($sql);
                if ($query) {
                ?>
                <div class="card-body">
