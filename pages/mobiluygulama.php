          ...
          <div class="col-sm-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Yeni Mobil Uygulama Ekle</h3>
                </div>
                <?php 
                if (isset($_POST['save'])) {
                    if ($_POST['save']==1001) {
                        ...
                        $sql="INSERT INTO qp_mobileapp (tittle,description,image,price,newprice,adddate,statu,user_id) VALUES (?,?,?,?,?,?,?,?) ";
                        $args= [$tittle, $description, $image, $price,$newprice, $adddate, $statu, $user_id ];
                        ...
                        if ($query) {
                            ...
                            header("refresh:1;url=mobiluygulama");
                        }
                        else {
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="newprice" class="form-control">
                    </div>
                  <div class="form-group">
              ...
              <div class="card-body">
                ...
                if (isset($_POST['deleteData'])) {
                  if ($_POST['deleteData']== 1001) {
                    ...
                    $sql1001 = "SELECT * FROM qp_mobileapp WHERE id IN ('$deleteData')";
                    $stmt = $adminclass->pdoQuery($sql1001);
                    $sql = "DELETE FROM qp_mobileapp WHERE id IN ('$deleteData')";
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><?php print $value->newprice; ?></td>
                    <td><?php print $adminclass->getStatu($value->statu);?></td>
                    <td>
                      <a href="mobiluygulama_edit?id=<?php print $value->id; ?>" class="btn btn-warning">Güncelle</a>
                    </td>
                  </tr>
                  <?php } }?>
                  </tbody>
